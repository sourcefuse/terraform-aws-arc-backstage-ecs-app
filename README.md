...
| <a name="input_environment_variables"></a> [environment\_variables](#input\_environment\_variables) | (optional) List of additional environment variables | `list(map(string))` | `[]` | no |
...
| <a name="input_secret_list"></a> [secret\_list](#input\_secret\_list) | (optional) List of additional Secrets | `list(map(string))` | `[]` | no |
