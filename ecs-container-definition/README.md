...
ECS Container definition module. Pulled from an earlier version of [aws-ia/ecs-blueprints](https://github.com/aws-ia/ecs-blueprints). The module was removed in the newer version, so we copied an older version to prevent our modules from breaking.
